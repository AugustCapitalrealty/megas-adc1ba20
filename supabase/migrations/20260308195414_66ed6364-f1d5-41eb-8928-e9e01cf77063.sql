...
-- 4. Update notify_backoffice_liberado_fornecedor to include prioridade
...
BEGIN
  IF NEW.status = 'liberado_fornecedor' 
    ...
    LOOP
      INSERT INTO notifications (user_id, tipo, titulo, mensagem, solicitacao_id, prioridade)
      VALUES (
