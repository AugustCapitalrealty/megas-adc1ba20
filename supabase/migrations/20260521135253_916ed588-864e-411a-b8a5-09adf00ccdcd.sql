    ...
    'solicitacao', (
      SELECT row_to_json(sol) FROM (
        SELECT 
          ...
          f.tipo_fornecedor as fornecedor_tipo_fornecedor,
          f.pais as fornecedor_pais,
          f.identificador_fiscal as fornecedor_identificador_fiscal,
          f.tipo_identificador_fiscal as fornecedor_tipo_identificador_fiscal,
          f.moeda_padrao as fornecedor_moeda_padrao,
          ...
          fc1.tipo_fornecedor as concorrente1_tipo_fornecedor,
          fc1.pais as concorrente1_pais,
          fc1.identificador_fiscal as concorrente1_identificador_fiscal,
          fc1.tipo_identificador_fiscal as concorrente1_tipo_identificador_fiscal,
          fc1.moeda_padrao as concorrente1_moeda_padrao,
          ...
          fc2.tipo_fornecedor as concorrente2_tipo_fornecedor,
          fc2.pais as concorrente2_pais,
          fc2.identificador_fiscal as concorrente2_identificador_fiscal,
          fc2.tipo_identificador_fiscal as concorrente2_tipo_identificador_fiscal,
          fc2.moeda_padrao as concorrente2_moeda_padrao
        FROM solicitacoes s
